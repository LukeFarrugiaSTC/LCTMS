...
--
-- Host: 127.0.0.1
-- Generation Time: May 01, 2025 at 11:06 AM
...
CREATE TABLE `bookings` (
  ...
  `client_id` int(255) NOT NULL COMMENT 'user_id as a foreign key from users table',
...
ALTER TABLE `bookings`
  ...
  ADD KEY `user_id-foreign` (`client_id`),
...
ALTER TABLE `bookings`
  ...
  ADD CONSTRAINT `user_id-foreign` FOREIGN KEY (`client_id`) REFERENCES `users` (`user_id`);
